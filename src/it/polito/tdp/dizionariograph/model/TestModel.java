...
public class TestModel {
	...
	public static void main(String[] args) {
		...
		List<String> vicini = model.displayNeighbours("pile");
		...
		System.out.println(model.findMaxWord());
		System.out.println("Neighbours di "+ model.findMaxWord() +": " + model.displayNeighbours(model.findMaxWord()) + "\n");
	}
